...
namespace ljh
{
    LJH_MODULE_MAIN_EXPORT template<typename T, int = 0>
    class function_pointer;

#define POINTERS_INTERALS(CC, Noexcept)                                                                                                                        \
    template<typename R, typename... Args>                                                                                                                     \
    class function_pointer<R LJH_CALLING_CONVENTION_##CC(Args...) LJH_NOEXCEPT_FUNCTION_TYPE(Noexcept),                                                        \
    ...
    public:                                                                                                                                                    \
        ...
        constexpr function_pointer(type other) noexcept                                                                                                        \
            : function{other}                                                                                                                                  \
        {}                                                                                                                                                     \
        constexpr explicit function_pointer(uintptr_t other) noexcept                                                                                          \
            : function{reinterpret_cast<type>(other)}                                                                                                          \
        {}                                                                                                                                                     \
        constexpr explicit function_pointer(void* other) noexcept                                                                                              \
            : function{reinterpret_cast<type>(other)}                                                                                                          \
        {}                                                                                                                                                     \
        template<typename T, typename = typename enable_function_pointer<T>::ref>                                                                              \
        constexpr explicit function_pointer(T other) noexcept                                                                                                  \
            : function{reinterpret_cast<type>(other)}                                                                                                          \
        {}                                                                                                                                                     \
                                                                                                                                                               \
        function_pointer& operator=(uintptr_t other) noexcept                                                                                                  \
        {                                                                                                                                                      \
            function = reinterpret_cast<type>(other);                                                                                                          \
            return *this;                                                                                                                                      \
        }                                                                                                                                                      \
        function_pointer& operator=(void* other) noexcept                                                                                                      \
        {                                                                                                                                                      \
            function = reinterpret_cast<type>(other);                                                                                                          \
            return *this;                                                                                                                                      \
        }                                                                                                                                                      \
        template<typename T>                                                                                                                                   \
        typename enable_function_pointer<T>::ref operator=(T other) noexcept                                                                                   \
        {                                                                                                                                                      \
            function = reinterpret_cast<type>(other);                                                                                                          \
            return *this;                                                                                                                                      \
        }                                                                                                                                                      \
        ...
        {                                                                                                                                                      \
            return function == reinterpret_cast<type>(other);                                                                                                  \
        }                                                                                                                                                      \
        ...
        template<typename T>                                                                                                                                   \
        typename enable_function_pointer<T>::boo operator==(T other) const noexcept                                                                            \
        {                                                                                                                                                      \
            return function == reinterpret_cast<type>(other);                                                                                                  \
        }                                                                                                                                                      \
                                                                                                                                                               \
        ...
        {                                                                                                                                                      \
            return !(*this == other);                                                                                                                          \
                                                                                                                                                               ...
                                                                                                                                                               \
        R operator()(Args... args) const LJH_NOEXCEPT_FUNCTION_TYPE(Noexcept)                                                                                  \
        {                                                                                                                                                      \
...
#else
#define MAKE_POINTERS(CC) POINTERS_INTERALS(CC, false)
#endif
...
static_assert(std::is_convertible<decltype(std::declval<ljh::function_pointer<void()>>() != nullptr), bool>::value,
              "ljh::function_pointer must be comparable to nullptr");