...
//          Copyright Jared Irwin 2022-2024
...
namespace ljh::__::co
{
	...
	struct winrt_task_completed_handler : winrt::Windows::Foundation::IUnknown
	{
		...
		winrt_task_completed_handler(winrt::weak_ref<O>&& object, M method)
			: winrt_task_completed_handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); }})
		{}

		auto operator()(winrt_task<TResult> const& asyncInfo, winrt::Windows::Foundation::AsyncStatus const& asyncStatus) const
		{
			check_hresult((*(winrt::impl::abi_t<winrt_task_completed_handler<TResult>>**)this)->Invoke(*(void**)(&asyncInfo), static_cast<int32_t>(asyncStatus)));
		}
	};
